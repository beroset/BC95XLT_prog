...
class RadioTest : public CppUnit::TestFixture {
    CPPUNIT_TEST_SUITE(RadioTest);
...
std::vector<RadioTest::ChannelPair> RadioTest::tstchannel{
...
CPPUNIT_TEST_SUITE_REGISTRATION(RadioTest);
